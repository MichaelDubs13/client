...
export default class f_Safety_GateSwitch_Config extends Component{
    constructor(parent, index, gate) {
        super(parent);
        this.parent = parent;
        this._classPath = "Config-IO_Modules.Mechatronic._fg_Safety_GateSwitches._f_Safety_GateSwitch_Config";
    ...
    get Parameters(){
        return [
            ...
            {name: "PowerDT", value: this._gate.source24VDC_location_dt, type: "String"},
            {name: "EthernetStation", value: this._gate.local_network_source_location, type: "String"},
            {name: "EthernetDT", value: this._gate.local_network_source_location_dt, type: "String"},
