...
export default class f_Device_DropConfig extends Component{
    ...
    get Parameters(){
        return [
                ...
                {name: "NotPLC_Connection_DT", value: this._drop.targetDT, type: "String"}, //if its a switch then its the target DT
                ...
                {name: "Connected_Device", value: this._drop.connectedDevice, type: "String"}, //if its a switch then its the target DT
            ];
