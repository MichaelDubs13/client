...
export default class F_Network_SwitchConfig extends Component{
    ...
    get Parameters(){
        return [
            // {name: "list_DevicePorts", value: [], type: "arrayList"},
            {name: "PLC_ID", value: "Undefined", type: "String"},
            // {name: "Singleline_Page", value: "", type: "Integer"},
            // {name: "Switch_Count_Selection", value: this.parent._switches.length, type: "Integer"},
            // {name: "Connected_Switches", value: this._Connected_Switches, type: "Boolean"},
            // {name: "Index_NetworkSwitch_DT_full", value: "", type: "Integer"},
            // {name: "NetworkSwitch_DT_full", value: this._networkSwitch.switch_location_dt, type: "String"},
            {name: "PWR_IN_Location", value: "Undefined", type: "String"},
            {name: "PWR_IN_DT", value: "Undefined", type: "String"},
            ...
            // {name: "PWR1_IN_IntPt_DT", value: this._PWR1_IN_IntPt_DT, type: "String"},
            ...
            // {name: "Unmanaged_Cascading", value: "", type: "Boolean"},
            ...
            {name: "Ethernet_DT", value: "Undefined", type: "String"},
            {name: "Ethernet_Location", value: "Undefined", type: "String"},
            ...
            // {name: "Switch_Title", value: "", type: "String"},
            // {name: "s_Port1_FuncText", value: "", type: "String"},
            // {name: "s_Port2_FuncText", value: "", type: "String"},
            // {name: "s_Port3_FuncText", value: "", type: "String"},
            // {name: "s_Port4_FuncText", value: "", type: "String"},
            // {name: "s_Port5_FuncText", value: "", type: "String"},
            // {name: "s_Port6_FuncText", value: "", type: "String"},
            // {name: "s_Port7_FuncText", value: "", type: "String"},
            // {name: "s_Port8_FuncText", value: "", type: "String"},
            // {name: "s_Port9_FuncText", value: "", type: "String"},
            // {name: "s_Port10_FuncText", value: "", type: "String"},
            // {name: "s_Port11_FuncText", value: "", type: "String"},
            // {name: "s_Port12_FuncText", value: "", type: "String"},
            // {name: "s_Port13_FuncText", value: "", type: "String"},
            // {name: "s_Port14_FuncText", value: "", type: "String"},
            // {name: "s_Port15_FuncText", value: "", type: "String"},
            // {name: "s_Port16_FuncText", value: "", type: "String"},
        ];
    }
