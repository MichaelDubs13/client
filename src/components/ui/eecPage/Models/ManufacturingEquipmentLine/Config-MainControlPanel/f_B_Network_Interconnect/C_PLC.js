...
export default class C_PLC extends Component{
    ...
    get Parameters(){
        return [
            {name: "Local_IP", value: this._mcp.plc_local_ip, type: "String"},
            {name: "Local_Secondary_IP", value: this._mcp.plc_local_ip_secondary, type: "String"},
            {name: "PLC_IP", value: this._mcp.plc_to_plc_ip, type: "String"}, // changed from 'plc_local_x1_ip' to 'plc_plc_ip' the port number for PLC to PLC communication
            {name: "Plant_IP", value: this._mcp.plc_plant_ip, type: "String"},
