...
import _f_DC_Distribution_Siemens from "../_f_DC_Distribution/_f_DC_Distribution_Siemens";

export default class _f_PSU_Siemens extends Component{
    constructor(parent, index, psu) {
        super(parent);
        this.parent = parent;
        const number = index > 1 ? index : "";
        this._classPath = "Config24V-PowerDistribution.Mechatronic._f_PSU_Siemens";
        this._class = "_f_PSU_Siemens";
        this._name = `_f_PSU_Siemens${number}`;
        this._psu = psu;
    }
    get Parameters(){
        return [
    ...
    build(){
        const dcDistribution = new _f_DC_Distribution_Siemens(this, this._psu);
