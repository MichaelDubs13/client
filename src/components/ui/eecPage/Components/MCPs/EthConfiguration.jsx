...
const EthConfiguration = ({mcp, index}) => {
    ...
    return ( 
         <div>
            <InputTextItem title={"Plant IP Address (e.g., 10.x.x.x)"} item={mcp} index={mcpIndex} property={"eth_plant_ip"} validation={isValidIP}/>
            <InputTextItem title={"PLC-to-PLC IP Address (e.g., 192.168.136.x)"} item={mcp} index={mcpIndex} property={"eth_plc_to_plc_ip"} validation={isValidIP}/>
            <InputTextItem title={"Local IP Address (e.g., 192.168..x)"} item={mcp} index={mcpIndex} property={"eth_local_ip"} validation={isValidIP}/>                                                    
