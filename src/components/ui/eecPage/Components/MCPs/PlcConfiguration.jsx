...
const PlcConfiguration = ({mcp, index}) => {
    ...
    return ( 
         <div>
            <InputTextItem title={"Plant IP Address (e.g., 10.x.x.x)"} item={mcp} index={mcpIndex} property={"plc_plant_ip"}/>
            <InputTextItem title={"PLC-to-PLC IP Address (e.g., 192.168.136.x)"} item={mcp} index={mcpIndex} property={"plc_to_plc_ip"}/>
            <InputTextItem title={"Local IP Address (e.g., 192.168..x)"} item={mcp} index={mcpIndex} property={"plc_local_ip"}/>
