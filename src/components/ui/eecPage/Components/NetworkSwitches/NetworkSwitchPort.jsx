...
import { networkSwitchConfiguration } from "../../Store/networkSwitchStore";
  ...
  const index = {networkSwitchIndex, portIndex};
  //const index = {networkSwitchIndex:networkSwitchIndex, portIndex:portIndex, ports:ports};
  
  //console.log("Ports:", networkSwitchIndex.ports);
      ...
      <div className="port-settings">
        ...
        {port.deviceTypeSelection === "Network Switch" && (
          <>
            ...
            {port.communciationFlow === "In" && port.cascadingSwitch (
              <>
            ...
            {port.communciationFlow === "Out" && port.cascadingSwitch (
              <>
